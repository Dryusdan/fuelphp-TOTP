...
$qrCode = GoogleAuthenticator::getQrCodeUrl('totp', 'dryusdan@hotmail.fr', $secret);
$keyUri = GoogleAuthenticator::getKeyUri('totp', 'dryusdan@hotmail.fr', $secret);
?><html>
<head>
